...
<head>
    ...
    <title>Pemantau Kesehatan Siswa Berbasis Web | User Information - <?= $_SESSION['user']['nama_lengkap'] ?></title>
</head>
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs card-header-tabs justify-content-between">
                            <div class="navbar mb-2">
                                <li class="nav-item">
                                    <a class="nav-link text-success active" aria-current="true" href="profile.php">Profil</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="profile-tab">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="edit.php" class="d-flex align-items-center text-dark">
                            ...
                            <div class="mb-2 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="nama_lengkap" id="nama_lengkap" placeholder="<?= $_SESSION["user"]["nama_lengkap"]; ?>" class="form-control" disabled readonly>
                                </div>
                            </div>
                            <div class="mb-2 row">
                                <label for="jenis_kelamin" class="col-sm-3">Jenis Kelamin</label>
                                <div class="col-sm-9">
                                    <input type="text" name="jenis_kelamin" id="jenis_kelamin" placeholder="<?= $_SESSION["user"]["jenis_kelamin"]; ?>" class="form-control" disabled readonly>
                                </div>
                            </div>
                            <div class="mb-2 row">
                                <label for="username" class="col-sm-3">Username</label>
                                <div class="col-sm-9">
                                    <input type="text" name="username" id="username" placeholder="<?= $_SESSION["user"]["username"]; ?>" class="form-control" disabled readonly>
                                </div>
                            </div>
                            <div class="mb-2 row">
                                <label for="kelas" class="col-sm-3">Kelas</label>
                                <div class="col-sm-9">
                                    <input type="text" name="kelas" id="kelas" placeholder="<?= $_SESSION["user"]["kelas"]; ?>" class="form-control" disabled readonly>
                                </div>
                            </div>
                            <div class="mb-2 row">
                                <label for="jurusan" class="col-sm-3">Jurusan</label>
                                <div class="col-sm-9">
                                    <input type="text" name="jurusan" id="jurusan" placeholder="<?= $_SESSION["user"]["jurusan"]; ?>" class="form-control" disabled readonly>
                                </div>
                            </div>
                        </div>
                    </div>
